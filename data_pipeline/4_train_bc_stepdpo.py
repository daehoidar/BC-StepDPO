...
from accelerate.utils import set_seed  # noqa: E402  (random/numpy/torch 한 번에 고정)
...
def main():
    ...
    # 재현성: random/numpy/torch(+cuda) seed 일괄 고정.
    ...
    loader = DataLoader(
        ...
        shuffle=True,
        generator=torch.Generator().manual_seed(seed),  # shuffle 순서 재현
